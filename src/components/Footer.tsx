      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="border-t border-gray-800 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="text-gray-500 text-sm text-center md:text-left">
            © {new Date().getFullYear()} Veramed Health Solutions | Founded by Shah Fahad
          </div>
          <div className="flex flex-wrap justify-center gap-6 text-sm text-gray-500">
            <Link to="/privacy-policy" className="hover:text-white">
              Privacy Policy
            </Link>
            <Link to="/terms-and-condition" className="hover:text-white">
              Terms of Service
            </Link>
            <Link to="/medical-desclaimar" className="hover:text-white">
              Medical Disclaimer
            </Link>
          </div>
        </div>
...
const ContactItem = ({
  ...
  >
    ...
    <span className="text-gray-300 group-hover:text-white transition-colors text-sm mt-1.5">
      {text}
    </span>
  </a>
);
