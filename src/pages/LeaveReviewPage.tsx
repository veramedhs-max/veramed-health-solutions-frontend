...
export const LeaveReviewPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!rating || !name.trim() || !review.trim() || !location.trim()) {
  ...
  return (
    <>
      {/* =================== SEO =================== */}
      <SEO
        title="Leave a Review | Veramed Health Solutions Patient Feedback"
        description="Share your experience with Veramed Health Solutions. Your review helps other patients make informed decisions about medical tourism and global healthcare."
        keywords="Veramed Health Solutions review, patient feedback, medical tourism reviews, healthcare experience"
        canonical="https://veramedhealthsolutions.com/leave-review"
        ogType="website"
